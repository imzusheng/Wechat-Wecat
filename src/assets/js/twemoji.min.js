...
var twemoji = (function () {
  ...
  var UFE0Fg = /\uFE0F/g; var U200D = String.fromCharCode(8205); var rescaper = /[&<>'"]/g
  var shouldntBeParsed = /^(?:iframe|noframes|noscript|script|select|style|textarea)$/
  ...
  function grabAllTextNodes (node, allText) {
    var childNodes = node.childNodes; var length = childNodes.length; var subnode; var nodeType
    while (length--) {
  ...
  function parseNode (node, options) {
    var allText = grabAllTextNodes(node, []); var length = allText.length; var attrib; var attrname; var modified; var fragment; var subnode
    var text; var match; var i; var index; var img; var rawText; var iconId; var src
    while (length--) {
      modified = false
  ...
  function parseString (str, options) {
    return replace(str, function (rawText) {
      var ret = rawText; var iconId = grabTheRightIcon(rawText); var src = options.callback(iconId, options); var attrib; var attrname
      if (iconId && src) {
